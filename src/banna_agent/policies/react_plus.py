...
REACT_PLUS_PROMPT_SUFFIX = (
    ...
    "  • Do NOT use `ask_user` to restate the request back to the user "
    "(\"What would you like me to help with?\"), and do NOT use it when "
    "you already have enough to answer. If a search returned usable "
    "results, answer from them — only one tool failing is not a reason "
